...
ic_input_filename = "/scratch/eubd/joao.reboucas/COLA_projects/first_runs/transfers_from_class/Omegam_low_transferinfo.txt"
...
output_folder = "/scratch/eubd/joao.reboucas/COLA_projects/first_runs/outputs/Omegam_low"
-- Label
simulation_name = "Omegam_low"
