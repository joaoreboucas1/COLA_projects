...
ic_input_filename = "/scratch/eubd/joao.reboucas/COLA_projects/first_runs/transfers_from_class/As_high_transferinfo.txt"
...
output_folder = "/scratch/eubd/joao.reboucas/COLA_projects/first_runs/outputs/As_high"
-- Label
simulation_name = "As_high"
